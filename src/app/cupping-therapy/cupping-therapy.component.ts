...
@Component({
  selector: 'app-cupping-therapy',
  templateUrl: './cupping-therapy.component.html',
  styleUrls: ['./cupping-therapy.component.css']
})
export class CuppingTherapyComponent implements OnInit {
